...
async function fetchData(placeObj) {
  ...
  const options = {
    ...
    headers: {
      ...
      Authorization:
        "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOjIsInVzZXJfZW1haWwiOiJzaGluLnl1YmluMThAZ21haWwuY29tIiwiaWF0IjoxNjk1OTgzMTY5LCJleHAiOjE2OTU5ODY3Njl9.XFKHKqlfoksRgxfpTLuzRig44G8EFhqzFYqYaSnIrro",
    },
    body: body,
  };
