...
async function fetchData(placeObj) {
  ...
  const options = {
    ...
    headers: {
      ...
      Authorization:
        "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOjEsInVzZXJfZW1haWwiOiJzaGluLnl1YmluMThAZ21haWwuY29tIiwiaWF0IjoxNjk1MDIyNTU5LCJleHAiOjE2OTUwMjYxNTl9.Sw55APRWqwI0iN1SdaKDRdM5f3HvGXwiA8guI-vS38c",
    },
    body: body,
  };
  try {
